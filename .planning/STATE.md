...
Last activity: 2026-03-03 - Completed quick task 039: Dep delete via predecessor chip (remove × button, chip click selects, predecessor row shows Удалить button)
