...
status: in_progress
stopped_at: "Completed quick-260316-wu6: редактирование прогресса для родительской задачи может быть только 100% (все дети помечаются сделанными)"
last_updated: "2026-03-16T20:38:36.642Z"
last_activity: "2026-03-16 - Completed quick task 260316-wu6: редактирование прогресса для родительской задачи может быть только 100% (все дети помечаются сделанными)"
progress:
  total_phases: 20
  completed_phases: 19
  total_plans: 51
...
| 78 | Toggle off dependency chip view on second click | 2026-03-09 | 71f5e10 | [78-chip-toggle-off](./quick/78-chip-toggle-off/) |
| 79 | сделай так чтобы при клике на чип связи график прокручивался к текущей задаче. только примени какой-то более простой и надёжный подход, а не как в коммите 6d05b2f7c680f36608ea5955dbd6eda4a4967f6a (без этого отключение связи работает нормально). | 2026-03-09 | 55d3382 | [79-6d05b2f7c680f36608ea5955dbd6eda4a4967f6a](./quick/79-6d05b2f7c680f36608ea5955dbd6eda4a4967f6a/) |
...
| 260316-wu6 | редактирование прогресса для родительской задачи может быть только 100% (все дети помечаются сделанными) | 2026-03-16 | 54b0bad | [260316-wu6-100](./quick/260316-wu6-100/) |
