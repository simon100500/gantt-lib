...
Last activity: 2026-03-09 - Completed quick task 79: сделай так чтобы при клике на чип связи график прокручивался к текущей задаче. только примени какой-то более простой и надёжный подход, а не как в коммите 6d05b2f7c680f36608ea5955dbd6eda4a4967f6a (без этого отключение связи работает нормально).
