...
export default function Home() {
  ...
  // Phase 21: Custom Weekends Task Lists
  const [showCustomWeekendsTaskList, setShowCustomWeekendsTaskList] = useState(true);
    ...
    <main>
      <div className="demo-page">
        ...
        <section className="demo-section">
          ...
          <div className="demo-controls">
            <button
              className={`demo-btn ${showCustomWeekendsTaskList ? "demo-btn-danger" : "demo-btn-primary"}`}
              onClick={() => setShowCustomWeekendsTaskList(!showCustomWeekendsTaskList)}
            >
              {showCustomWeekendsTaskList ? "Hide Task List" : "Show Task List"}
            </button>
            <div className="demo-datepicker">
              <label>Check calendar: </label>
              <input type="date" defaultValue="2026-03-08" min="2026-03-01" max="2026-03-31" />
              <span className="demo-hint">(March 8 & 10 are holidays)</span>
            </div>
          </div>
          <div className="demo-chart-card">
            <GanttChart
              tasks={[
                { id: 'cw-1', name: 'Подготовка проекта', startDate: '2026-03-05', endDate: '2026-03-12' },
                { id: 'cw-2', name: 'Разработка спецификаций', startDate: '2026-03-11', endDate: '2026-03-18' },
                { id: 'cw-3', name: 'Согласование', startDate: '2026-03-15', endDate: '2026-03-22' },
                { id: 'cw-4', name: 'Утверждение', startDate: '2026-03-20', endDate: '2026-03-25' },
              ]}
              weekends={[
              ...
              rowHeight={40}
              containerHeight={240}
              showTaskList={showCustomWeekendsTaskList}
            />
            <div className="demo-calendar-wrapper">
              <Calendar
                initialDate={new Date(Date.UTC(2026, 2, 1))}
                weekends={[
                  new Date(Date.UTC(2026, 2, 8)),  // March 8 (Saturday) - holiday
                  new Date(Date.UTC(2026, 2, 10)), // March 10 (Monday) - holiday
                ]}
        ...
        <section className="demo-section">
          ...
          <div className="demo-controls">
            ...
            <div className="demo-datepicker">
              <label>Check calendar: </label>
              <input type="date" defaultValue="2026-03-15" min="2026-03-10" max="2026-03-25" />
              <span className="demo-hint">(March 15 & 16 are workdays)</span>
            </div>
          </div>
          <div className="demo-chart-card">
            <GanttChart
              tasks={[
                { id: 'wd-1', name: 'Анализ требований', startDate: '2026-03-10', endDate: '2026-03-18' },
                { id: 'wd-2', name: 'Проектирование', startDate: '2026-03-14', endDate: '2026-03-22' },
                { id: 'wd-3', name: 'Разработка', startDate: '2026-03-18', endDate: '2026-03-26' },
                { id: 'wd-4', name: 'Тестирование', startDate: '2026-03-23', endDate: '2026-03-30' },
              ]}
              workdays={[
        ...
        <section className="demo-section">
          ...
          <div className="demo-controls">
            ...
            <div className="demo-datepicker">
              <label>Check calendar: </label>
              <input type="date" defaultValue="2026-03-22" min="2026-03-17" max="2026-03-28" />
              <span className="demo-hint">(March 22 is in both arrays - workday wins)</span>
            </div>
          </div>
          <div className="demo-chart-card">
            <GanttChart
              tasks={[
                { id: 'prec-1', name: 'Планирование sprint 1', startDate: '2026-03-17', endDate: '2026-03-24' },
                { id: 'prec-2', name: 'Разработка sprint 1', startDate: '2026-03-22', endDate: '2026-03-28' },
                { id: 'prec-3', name: 'Ревью кода', startDate: '2026-03-25', endDate: '2026-03-30' },
              ]}
              weekends={[
        ...
        <section className="demo-section">
          ...
          <div className="demo-controls">
            ...
            <div className="demo-datepicker">
              <label>Check calendar: </label>
              <input type="date" defaultValue="2026-03-07" min="2026-03-03" max="2026-03-16" />
              <span className="demo-hint">(Only Sundays are weekends)</span>
            </div>
          </div>
          <div className="demo-chart-card">
            <GanttChart
              tasks={[
                { id: 'pred-1', name: 'Проектирование системы', startDate: '2026-03-03', endDate: '2026-03-10' },
                { id: 'pred-2', name: 'Разработка API', startDate: '2026-03-08', endDate: '2026-03-16' },
                { id: 'pred-3', name: 'Написание тестов', startDate: '2026-03-12', endDate: '2026-03-18' },
              ]}
        ...
        <section className="demo-section">
          ...
          <div className="demo-controls">
            ...
            <div className="demo-datepicker">
              <label>Check March: </label>
              <input type="date" defaultValue="2026-03-08" min="2026-03-01" max="2026-03-31" />
              <label>Check April: </label>
              <input type="date" defaultValue="2026-04-10" min="2026-04-01" max="2026-04-30" />
              <span className="demo-hint">(March 8 & April 10 are holidays)</span>
            </div>
          </div>
          <div className="demo-chart-card">
            <GanttChart
              tasks={[
                { id: 'mm-1', name: 'Этап 1: Анализ', startDate: '2026-03-01', endDate: '2026-03-20' },
                { id: 'mm-2', name: 'Этап 2: Проектирование', startDate: '2026-03-15', endDate: '2026-04-10' },
                { id: 'mm-3', name: 'Этап 3: Разработка', startDate: '2026-04-05', endDate: '2026-04-25' },
                { id: 'mm-4', name: 'Этап 4: Тестирование', startDate: '2026-04-15', endDate: '2026-04-30' },
              ]}
              weekends={[
